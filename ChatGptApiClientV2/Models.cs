...
public class ModelVersionInfo
{
    ...
    [
        ...
        new ModelVersionInfo { ModelType = "gpt-4-128k", Name = "gpt-4-0125-preview", Description = "2024-01-25", KnowledgeCutoff = new DateTime(2023, 4, 1), FunctionCallSupported = true },
