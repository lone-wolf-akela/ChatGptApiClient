...
namespace Gemini
{
    ...
    public sealed partial class DynamicRetrievalConfig
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Gemini.JsonConverters.DynamicRetrievalConfigModeJsonConverter))]
        public global::Gemini.DynamicRetrievalConfigMode? Mode { get; set; }

        /// <summary>
        /// The threshold to be used in dynamic retrieval.<br/>
        ...
        public DynamicRetrievalConfig(
            global::Gemini.DynamicRetrievalConfigMode? mode,
