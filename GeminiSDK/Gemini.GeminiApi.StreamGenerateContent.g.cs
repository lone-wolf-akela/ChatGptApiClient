...
namespace Gemini
{
    ...
    {
        partial void PrepareStreamGenerateContentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string model,
            global::Gemini.GenerateContentRequest request);
        partial void PrepareStreamGenerateContentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string model,
            global::Gemini.GenerateContentRequest request);
        partial void ProcessStreamGenerateContentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessStreamGenerateContentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gemini.GenerateContentResponse> StreamGenerateContentAsync(
            string model,
            global::Gemini.GenerateContentRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareStreamGenerateContentArguments(
            ...
            PrepareStreamGenerateContentRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessStreamGenerateContentResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessStreamGenerateContentResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await StreamGenerateContentAsync(
                model: model,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
