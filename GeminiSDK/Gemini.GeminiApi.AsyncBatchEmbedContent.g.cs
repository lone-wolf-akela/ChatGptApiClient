...
namespace Gemini
{
    ...
    {
        partial void PrepareAsyncBatchEmbedContentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string model,
            global::Gemini.AsyncBatchEmbedContentRequest request);
        partial void PrepareAsyncBatchEmbedContentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string model,
            global::Gemini.AsyncBatchEmbedContentRequest request);
        partial void ProcessAsyncBatchEmbedContentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAsyncBatchEmbedContentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gemini.AsyncBatchEmbedContentOperation> AsyncBatchEmbedContentAsync(
            string model,
            global::Gemini.AsyncBatchEmbedContentRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAsyncBatchEmbedContentArguments(
                httpClient: HttpClient,
                model: ref model,
                request: request);

            var __pathBuilder = new global::Gemini.PathBuilder(
                path: $"/v1beta/models/{model}:asyncBatchEmbedContent",
            ...
            PrepareAsyncBatchEmbedContentRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAsyncBatchEmbedContentResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAsyncBatchEmbedContentResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AsyncBatchEmbedContentAsync(
                model: model,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
