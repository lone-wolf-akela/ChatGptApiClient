...
namespace Gemini
{
    public partial class GeminiApi
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Gemini.Model> GetModelAsync(
            string model,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (!__response.IsSuccessStatusCode)
            {
                ...
                global::Gemini.Model? __value_default = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_default = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_default = global::Gemini.Model.FromJson(__content_default, JsonSerializerContext);
                    }
                    else
                    {
                        var __contentStream_default = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                        __value_default = await global::Gemini.Model.FromJsonStreamAsync(__contentStream_default, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                ...
                throw new global::Gemini.ApiException<global::Gemini.Model>(
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Gemini.Model.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Gemini.Model.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
