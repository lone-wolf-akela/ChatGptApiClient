...
namespace Gemini
{
    ...
    {
        partial void PrepareStreamGenerateContentByTunedModelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string tunedModel,
            global::Gemini.GenerateContentRequest request);
        partial void PrepareStreamGenerateContentByTunedModelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string tunedModel,
            global::Gemini.GenerateContentRequest request);
        partial void ProcessStreamGenerateContentByTunedModelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessStreamGenerateContentByTunedModelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gemini.GenerateContentResponse> StreamGenerateContentByTunedModelAsync(
            string tunedModel,
            global::Gemini.GenerateContentRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareStreamGenerateContentByTunedModelArguments(
                httpClient: HttpClient,
                tunedModel: ref tunedModel,
                request: request);

            var __pathBuilder = new global::Gemini.PathBuilder(
                path: $"/v1beta/tunedModels/{tunedModel}:streamGenerateContent",
            ...
            PrepareStreamGenerateContentByTunedModelRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessStreamGenerateContentByTunedModelResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessStreamGenerateContentByTunedModelResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await StreamGenerateContentByTunedModelAsync(
                tunedModel: tunedModel,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
