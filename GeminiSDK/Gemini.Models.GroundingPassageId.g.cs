...
namespace Gemini
{
    ...
    {
        /// <summary>
        /// Output only. ID of the passage matching the `GenerateAnswerRequest`'s<br/>
        /// `GroundingPassage.id`.<br/>
        ...
        /// <summary>
        /// Output only. Index of the part within the `GenerateAnswerRequest`'s<br/>
        /// `GroundingPassage.content`.<br/>
        /// Included only in responses
        /// </summary>
