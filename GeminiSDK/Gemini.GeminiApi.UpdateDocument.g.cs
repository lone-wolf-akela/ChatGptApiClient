...
namespace Gemini
{
    public partial class GeminiApi
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Gemini.Document> UpdateDocumentAsync(
            string corpus,
            string document,
            string updateMask,
            global::Gemini.Document request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __pathBuilder = new global::Gemini.PathBuilder(
                path: $"/v1beta/corpora/{corpus}/documents/{document}",
            ...
            if (!__response.IsSuccessStatusCode)
            {
                ...
                global::Gemini.Document? __value_default = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_default = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_default = global::Gemini.Document.FromJson(__content_default, JsonSerializerContext);
                    }
                    else
                    {
                        var __contentStream_default = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                        __value_default = await global::Gemini.Document.FromJsonStreamAsync(__contentStream_default, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                ...
                throw new global::Gemini.ApiException<global::Gemini.Document>(
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Gemini.Document.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Gemini.Document.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Gemini.Document> UpdateDocumentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Gemini.Document
            {
                Name = name,
