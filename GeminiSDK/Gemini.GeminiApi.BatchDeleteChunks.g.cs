...
namespace Gemini
{
    ...
    {
        partial void PrepareBatchDeleteChunksArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string corpus,
            ref string document,
            global::Gemini.BatchDeleteChunksRequest request);
        partial void PrepareBatchDeleteChunksRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string corpus,
            string document,
            global::Gemini.BatchDeleteChunksRequest request);
        partial void ProcessBatchDeleteChunksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBatchDeleteChunksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> BatchDeleteChunksAsync(
            string corpus,
            string document,
            global::Gemini.BatchDeleteChunksRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBatchDeleteChunksArguments(
            ...
            var __pathBuilder = new global::Gemini.PathBuilder(
                path: $"/v1beta/corpora/{corpus}/documents/{document}/chunks:batchDelete",
            ...
            PrepareBatchDeleteChunksRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessBatchDeleteChunksResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessBatchDeleteChunksResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> BatchDeleteChunksAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Gemini.BatchDeleteChunksRequest
            {
                Requests = requests,
            };

            return await BatchDeleteChunksAsync(
                corpus: corpus,
                document: document,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
