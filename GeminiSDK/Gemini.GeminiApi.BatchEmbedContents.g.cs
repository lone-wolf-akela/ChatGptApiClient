...
namespace Gemini
{
    public partial class GeminiApi
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Gemini.BatchEmbedContentsResponse> BatchEmbedContentsAsync(
            string model,
            global::Gemini.BatchEmbedContentsRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (!__response.IsSuccessStatusCode)
            {
                ...
                global::Gemini.BatchEmbedContentsResponse? __value_default = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_default = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_default = global::Gemini.BatchEmbedContentsResponse.FromJson(__content_default, JsonSerializerContext);
                    }
                    else
                    {
                        var __contentStream_default = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                        __value_default = await global::Gemini.BatchEmbedContentsResponse.FromJsonStreamAsync(__contentStream_default, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                ...
                throw new global::Gemini.ApiException<global::Gemini.BatchEmbedContentsResponse>(
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Gemini.BatchEmbedContentsResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Gemini.BatchEmbedContentsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Gemini.BatchEmbedContentsResponse> BatchEmbedContentsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Gemini.BatchEmbedContentsRequest
            {
                Requests = requests,
            };
