...
namespace Gemini
{
    ...
    {
        /// <summary>
        /// Immutable. The name of the `TunedModel` to use as the starting point for<br/>
        /// training the new model.<br/>
        ...
        /// <summary>
        /// Output only. The name of the base `Model` this `TunedModel` was tuned from.<br/>
        /// Example: `models/gemini-1.5-flash-001`<br/>
