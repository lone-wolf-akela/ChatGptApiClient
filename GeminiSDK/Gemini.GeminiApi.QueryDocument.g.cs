...
namespace Gemini
{
    ...
    {
        partial void PrepareQueryDocumentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string corpus,
            ref string document,
            global::Gemini.QueryDocumentRequest request);
        partial void PrepareQueryDocumentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string corpus,
            string document,
            global::Gemini.QueryDocumentRequest request);
        partial void ProcessQueryDocumentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQueryDocumentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gemini.QueryDocumentResponse> QueryDocumentAsync(
            string corpus,
            string document,
            global::Gemini.QueryDocumentRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __pathBuilder = new global::Gemini.PathBuilder(
                path: $"/v1beta/corpora/{corpus}/documents/{document}:query",
            ...
            if (!__response.IsSuccessStatusCode)
            {
                ...
                global::Gemini.QueryDocumentResponse? __value_default = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_default = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_default = global::Gemini.QueryDocumentResponse.FromJson(__content_default, JsonSerializerContext);
                    }
                    else
                    {
                        var __contentStream_default = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                        __value_default = await global::Gemini.QueryDocumentResponse.FromJsonStreamAsync(__contentStream_default, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                ...
                throw new global::Gemini.ApiException<global::Gemini.QueryDocumentResponse>(
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessQueryDocumentResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::Gemini.QueryDocumentResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Gemini.QueryDocumentResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Gemini.QueryDocumentResponse> QueryDocumentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Gemini.QueryDocumentRequest
            {
                Query = query,
            ...
            return await QueryDocumentAsync(
                corpus: corpus,
                document: document,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
